...
object MainConfig {
    ...
    init {
        ...
        val scriptingModeStr = config.getString(
        ...
        modelPackLoadSpeed = ModelPackLoadSpeed.byValue(
            config.getInt(
        ...
        scriptingMode = ScriptingMode.getByConfigValue(scriptingModeStr) ?: let {
            if (scriptingModeStr != ScriptingMode.defaultConfigValue)
    ...
    enum class ScriptingMode(vararg val configValues: String) {
        ...
        companion object {
            private val byConfigValue = values().flatMap { it.configValues.map { k -> k to it } }.toMap()
    ...
    enum class ModelPackLoadSpeed(val configValue: Int, val description: String) {
        ...
        WorkStealing(3, "Fastest; use all processors");
